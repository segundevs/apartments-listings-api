...
const createApartment = async(req, res) => {
  ...
  const newApartment = new Apartment({...req.body, userId: userID });
...
const updateApartment = async(req, res) => {
  ...
  if(apt.userId === req.user.uid){
    try{
      const updatedApartment = await Apartment.findByIdAndUpdate(id, {$set: req.body}, {new: true})
...
module.exports = {getAllApartments, getApartmentById, createApartment, deleteApartment, updateApartment}